...
maswayvpnnnn="raw.githubusercontent.com/mymasway/XRAY/main/stunnel5"

maswayvpnnnnn="raw.githubusercontent.com/mymasway/XRAY/main/update"
# initializing var
...
wget -O menuu "https://${maswayvpn}/menuu.sh"
...
#wget -O ins-sshws "https://${maswayvpn}/ins-sshws.sh"
#wget -O sshws-true "https://${maswayvpn}/sshws-true.sh"
...
wget -O portstunnel5 "https://${maswayvpn}/portstunnel5.sh"
wget -O portdropbear "https://${maswayvpn}/portdropbear.sh"
wget -O portopenssh "https://${maswayvpn}/portopenssh.sh"
wget -O portsshnontls "https://${maswayvpn}/portsshnontls.sh"
wget -O portsshwstls "https://${maswayvpn}/portsshwstls.sh"
wget -O sshovpnmenu "https://${maswayvpnnnnn}/sshovpnmenu.sh"
wget -O setmenu "https://${maswayvpnnnnn}/setmenu.sh"
wget -O menutester "https://${maswayvpnnnnn}/menutester.sh"
wget -O menu "https://${maswayvpnnnnn}/menu.sh"
wget -O status "https://${maswayvpnnnnn}/status.sh"
